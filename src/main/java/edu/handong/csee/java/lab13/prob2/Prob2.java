...
public class Prob2//The declaration of class Prob2
{
	...
	public static void main(String[] args)//The declaration of static main method without return value
	{
		...
		Science book2=new Science("Hello Physics!","ScienceWorld");//Instantiate of an Science object, calling constructor, values of parameter are "Hello Physics!" and "ScienceWorld" at this time
